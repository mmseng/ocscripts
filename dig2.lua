...
local function usage()
	...
	io.write("	dig -j <depth> <width> <height> <jump_to>\n")
	io.write("	dig -C <cubic_size>\n")
	io.write("	dig -S <square_size>\n")
	io.write("Arguments:\n")
	...
	io.write("		Requires a single argument for <cubic_size>. Not compatible with -S or -j.\n")
	io.write("	<square_size>: If option -S is given, this value is used for <depth> and <width>. <height> is set to max.\n")
	io.write("		Requires a single argument for <square_size>. Not compatible with -C or -j.\n")
	io.write("	<jump_to>: If option -j is given, the robot will move to this layer and start digging from there downward.\n")
	io.write("		e.g. if <jump_to> is 5 it will start digging layers 5, 6, and 7 (unless <height> is less than 7).\n")
	io.write("		-j requires all 4 dimensions to be given. Not compatible with -C or -S.\n")
	io.write("Options:\n")
	io.write("	-s: shutdown when done\n")
	io.write("	-C: digs a cube of size <cubic_size>\n")
end
